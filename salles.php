...
//$requser->execute(array(2))
   $user = $requser->fetch();
   $msg = $bdd->prepare('SELECT * FROM salles where disponible="y"');
		...
		<div class="container">
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Nos Salles</h2>
					<p>recherchez parmis les nombreuses salles de réceptions en location la salle idéal pour votre évenement</p>
				</div>
			</div>
