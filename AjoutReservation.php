...
try {
 $bdd = new PDO('mysql:host=localhost;dbname=base_event', 'root', '');
  ...
  $sql = 'INSERT INTO reservationsalles VALUES(:name ,:datee ,:nomReserv )';
...
$statement->execute([
	':name' => $nomSalle,
	':datee' => $date,
	':nomReserv' => $nomReservation
]);
  $erreur="Votre Reservation est effectué avec succées";
} catch(PDOException $e) {
  $erreur=$sql . "<br>" . $e->getMessage();
}
				...
				<div class="col-xs-10 text-right menu-1">
					<ul>
						...
						<li class="has-dropdown active">
							...
							<ul class="dropdown">
								<li><a href="#">sales des fêtes </a></li>
								<li><a href="#">le banquet </a></li>
								<li><a href="#">décoration</a></li>
								<li><a href="#">photographes</a></li>
								<li><a href="#">groupes musicaux</a></li>
								<li><a href="#">fleuriste mariages</a></li>
							</ul>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
								...
								<h1 class="page-header"><i class="glyphicon glyphicon-user"></i> <?php echo $user['pseudo']; ?>
							</h1>
							<?php
         if(isset($erreur)) {
            echo '<h1 class="page-header">'.$erreur."</h1>";
